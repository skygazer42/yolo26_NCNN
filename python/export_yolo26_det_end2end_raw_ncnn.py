...
def _patch_postprocess_identity(model):
    ...
    # This keeps one2one (end2end) decoding, but outputs raw predictions (B, anchors, 4+nc).
...
def main():
    ...
    ap.add_argument("--weights", default="yolo26n.pt", help="Path to YOLO26 .pt weights")
    ...
    # Prefer the local Ultralytics tree for strict alignment.
